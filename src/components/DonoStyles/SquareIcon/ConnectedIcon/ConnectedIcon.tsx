    ...
    <div className='connected__icon'>
      <svg width='20' height='15' viewBox='0 0 20 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
          ...
          fill={connected ? 'var(--high-speed)' : 'var(--low-speed)'}
          stroke='rgba(255, 255, 255, 0.7)'
          strokeWidth='2'
          strokeLinecap='round'
          strokeLinejoin='round'
        />
        <path d='M10.7879 5.3078V7.15904H8.93665' strokeWidth='1.2' stroke='white' strokeLinecap='round' strokeLinejoin='round' />
        <path d='M4 10.2444V8.39319H5.85124' strokeWidth='1.2' stroke='white' strokeLinecap='round' strokeLinejoin='round' />
        <path
